...
from opendivination.core.sampling import rejection_sample, rejection_sample_weighted
from opendivination.corpora.iching import hexagram_by_lines, load_iching_corpus
...
async def _compute_iching_coherence(
    hexagram: Hexagram,
    question: str,
    ...
    symbol_text = build_iching_hexagram_text(hexagram)
...
async def draw_iching(
    ...
    *,
    ...
    if question is not None and provider is not None:
        coherence = await _compute_iching_coherence(primary, question, provider)
